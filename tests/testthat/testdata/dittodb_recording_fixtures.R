...
# con_test <- make_test_connection()
# fix_ecb_url()
# prepare_vintage_table("ECS.Q.I9.N.4D1.CNS051_50.A1", con_test)
# stop_db_capturing()
...
con_test <- make_test_connection()
fix_ecb_url()
ECB_import_data_points("ECS.Q.I9.N.4D1.CNS051_50.A1", con_test)
stop_db_capturing()
...
ECB_import_data_points("BSI.M.AT.N.A.T00.A.1.Z5.0000.Z01.E", con_test)

con_test <- make_test_connection()
fix_ecb_url()
debugonce(prepare_ecb_data_for_insert)

prepare_ecb_data_for_insert("BSI.M.AT.N.A.T00.A.1.Z5.0000.Z01.E", con_test)
ECB_import_data_points("BSI.M.AT.N.A.T00.A.1.Z5.0000.Z01.E", con_test)
